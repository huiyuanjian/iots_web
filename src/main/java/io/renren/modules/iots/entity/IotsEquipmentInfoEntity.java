 ...
 */
@TableName("iots_equipment_info")
public class IotsEquipmentInfoEntity implements Serializable {
	...
	private List<IotsVariableInfoEntity> list = new ArrayList<IotsVariableInfoEntity>();
	...
	public List<IotsVariableInfoEntity> getList() {
		return list;
	}
	public void setList(List<IotsVariableInfoEntity> list) {
		this.list = list;
	}
