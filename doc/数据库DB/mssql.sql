...
INSERT INTO sys_menu (menu_id, parent_id, name, url, perms, type, icon, order_num) VALUES ('29', '1', '系统日志', 'modules/sys/controller.html', 'sys:controller:list', '1', 'fa fa-file-text-o', '7');
...
INSERT INTO sys_menu (menu_id, parent_id, name, url, perms, type, icon, order_num) VALUES ('14', '6', '日志列表', NULL, 'sys:schedule:controller', '2', NULL, '0');
SET IDENTITY_INSERT sys_menu OFF;
